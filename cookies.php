      ...
      <div class="row">
        <div class="col-12 text-page">
          <div class="text-container">
            ...
            <p>
              SanTour ("us", "we", or "our") uses cookies on SanTour (the "Service"). By using the Service, you consent to the use of cookies.
              <br>
            ...
            <h2>How SanTour uses cookies</h2>
            <p>
            ...
            <a target="_blank" href="http://www.allaboutcookies.org/">AllAboutCookies</a>
            <br>
            <a target="_blank" href="http://www.networkadvertising.org/">Network Advertising Initiative</a>
